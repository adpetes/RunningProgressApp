...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[70px] flex justify-between items-center px-4 bg-[#f0e9ae] text-gray-800">
      <div>
      ...
      <ul className='hidden md:flex'>
        ...
        <li>
          <Link to='stats' offset={-150} smooth={true} duration={100}>
            Stats
          </Link>
        </li>
        <li>
      ...
      <div>
        <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#243E36] flex flex-col justify-center items-center'}>
          ...
          <li className="py-6 text-4xl"> 
            <Link to='stats' smooth={true} duration={100} onClick={handleClick}>
              Stats
            </Link> 
          </li>
          <li className="py-6 text-4xl"> 
